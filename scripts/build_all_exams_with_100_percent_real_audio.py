...
# Split by Mondai for N5:
# N5 Vol 1 & Vol 2 have: M1: 7 Qs, M2: 6 Qs, M3: 5 Qs, M4: 6 Qs
N5_V1_M1 = OFFICIAL_N5_VOL1_LISTENING[0:7]
N5_V1_M2 = OFFICIAL_N5_VOL1_LISTENING[7:13]
N5_V1_M3 = OFFICIAL_N5_VOL1_LISTENING[13:18]
N5_V1_M4 = OFFICIAL_N5_VOL1_LISTENING[18:24]

N5_V2_M1 = OFFICIAL_N5_VOL2_LISTENING[0:7]
N5_V2_M2 = OFFICIAL_N5_VOL2_LISTENING[7:13]
N5_V2_M3 = OFFICIAL_N5_VOL2_LISTENING[13:18]
N5_V2_M4 = OFFICIAL_N5_VOL2_LISTENING[18:24]

# Split by Mondai for N4:
# N4 Vol 1 & Vol 2 have: M1: 8 Qs, M2: 7 Qs, M3: 5 Qs, M4: 8 Qs
N4_V1_M1 = OFFICIAL_N4_VOL1_LISTENING[0:8]
N4_V1_M2 = OFFICIAL_N4_VOL1_LISTENING[8:15]
N4_V1_M3 = OFFICIAL_N4_VOL1_LISTENING[15:20]
N4_V1_M4 = OFFICIAL_N4_VOL1_LISTENING[20:28]

N4_V2_M1 = OFFICIAL_N4_VOL2_LISTENING[0:8]
N4_V2_M2 = OFFICIAL_N4_VOL2_LISTENING[8:15]
N4_V2_M3 = OFFICIAL_N4_VOL2_LISTENING[15:20]
N4_V2_M4 = OFFICIAL_N4_VOL2_LISTENING[20:28]
...
def build_n5_listening_for_exam(exam_idx):
    if exam_idx == 1:
        ...
        m1 = [N5_V1_M1[0], N5_V2_M1[1], N5_V1_M1[2], N5_V2_M1[3], N5_V1_M1[4], N5_V2_M1[5], N5_V1_M1[6]]
        m2 = [N5_V2_M2[0], N5_V1_M2[1], N5_V2_M2[2], N5_V1_M2[3], N5_V2_M2[4], N5_V1_M2[5]]
        m3 = [N5_V1_M3[0], N5_V2_M3[1], N5_V1_M3[2], N5_V2_M3[3], N5_V1_M3[4]]
        m4 = [N5_V2_M4[0], N5_V1_M4[1], N5_V2_M4[2], N5_V1_M4[3], N5_V2_M4[4], N5_V1_M4[5]]
    elif exam_idx == 4:
        m1 = [N5_V2_M1[0], N5_V1_M1[1], N5_V2_M1[2], N5_V1_M1[3], N5_V2_M1[4], N5_V1_M1[5], N5_V2_M1[6]]
        m2 = [N5_V1_M2[0], N5_V2_M2[1], N5_V1_M2[2], N5_V2_M2[3], N5_V1_M2[4], N5_V2_M2[5]]
        m3 = [N5_V2_M3[0], N5_V1_M3[1], N5_V2_M3[2], N5_V1_M3[3], N5_V2_M3[4]]
        m4 = [N5_V1_M4[0], N5_V2_M4[1], N5_V1_M4[2], N5_V2_M4[3], N5_V1_M4[4], N5_V2_M4[5]]
    elif exam_idx == 5:
        m1 = N5_V1_M1
        m2 = N5_V2_M2
        m3 = [N5_V2_M3[1], N5_V1_M3[2], N5_V2_M3[3], N5_V1_M3[4], N5_V2_M3[0]]
        m4 = [N5_V1_M4[1], N5_V2_M4[2], N5_V1_M4[3], N5_V2_M4[4], N5_V1_M4[5], N5_V2_M4[0]]
    elif exam_idx == 6:
        m1 = N5_V2_M1
        m2 = N5_V1_M2
        m3 = [N5_V1_M3[1], N5_V2_M3[2], N5_V1_M3[3], N5_V2_M3[4], N5_V1_M3[0]]
        m4 = [N5_V2_M4[1], N5_V1_M4[2], N5_V2_M4[3], N5_V1_M4[4], N5_V2_M4[5], N5_V1_M4[0]]
    elif exam_idx == 7:
        m1 = [N5_V1_M1[1], N5_V1_M1[3], N5_V1_M1[5], N5_V2_M1[0], N5_V2_M1[2], N5_V2_M1[4], N5_V2_M1[6]]
        m2 = [N5_V1_M2[1], N5_V1_M2[3], N5_V1_M2[5], N5_V2_M2[0], N5_V2_M2[2], N5_V2_M2[4]]
        m3 = [N5_V1_M3[1], N5_V1_M3[3], N5_V2_M3[0], N5_V2_M3[2], N5_V2_M3[4]]
        m4 = [N5_V1_M4[1], N5_V1_M4[3], N5_V1_M4[5], N5_V2_M4[0], N5_V2_M4[2], N5_V2_M4[4]]
    elif exam_idx == 8:
        m1 = [N5_V2_M1[1], N5_V2_M1[3], N5_V2_M1[5], N5_V1_M1[0], N5_V1_M1[2], N5_V1_M1[4], N5_V1_M1[6]]
        m2 = [N5_V2_M2[1], N5_V2_M2[3], N5_V2_M2[5], N5_V1_M2[0], N5_V1_M2[2], N5_V1_M2[4]]
        m3 = [N5_V2_M3[1], N5_V2_M3[3], N5_V1_M3[0], N5_V1_M3[2], N5_V1_M3[4]]
        m4 = [N5_V2_M4[1], N5_V2_M4[3], N5_V2_M4[5], N5_V1_M4[0], N5_V1_M4[2], N5_V1_M4[4]]
    elif exam_idx == 9:
        m1 = [N5_V1_M1[6], N5_V1_M1[5], N5_V1_M1[4], N5_V2_M1[3], N5_V2_M1[2], N5_V2_M1[1], N5_V2_M1[0]]
        m2 = [N5_V1_M2[5], N5_V1_M2[4], N5_V1_M2[3], N5_V2_M2[2], N5_V2_M2[1], N5_V2_M2[0]]
        m3 = [N5_V1_M3[4], N5_V1_M3[3], N5_V1_M3[2], N5_V2_M3[1], N5_V2_M3[0]]
        m4 = [N5_V1_M4[5], N5_V1_M4[4], N5_V1_M4[3], N5_V2_M4[2], N5_V2_M4[1], N5_V2_M4[0]]
    else: # 10
        m1 = [N5_V2_M1[6], N5_V2_M1[5], N5_V2_M1[4], N5_V1_M1[3], N5_V1_M1[2], N5_V1_M1[1], N5_V1_M1[0]]
        m2 = [N5_V2_M2[5], N5_V2_M2[4], N5_V2_M2[3], N5_V1_M2[2], N5_V1_M2[1], N5_V1_M2[0]]
        m3 = [N5_V2_M3[4], N5_V2_M3[3], N5_V2_M3[2], N5_V1_M3[1], N5_V1_M3[0]]
        m4 = [N5_V2_M4[5], N5_V2_M4[4], N5_V2_M4[3], N5_V1_M4[2], N5_V1_M4[1], N5_V1_M4[0]]
    ...
    for i, q in enumerate(m1 + m2 + m3 + m4):
        ...
        # Update question number display: e.g. "1. ..."
...
def build_n4_listening_for_exam(exam_idx):
    if exam_idx == 1:
        ...
        m1 = [N4_V1_M1[0], N4_V2_M1[1], N4_V1_M1[2], N4_V2_M1[3], N4_V1_M1[4], N4_V2_M1[5], N4_V1_M1[6], N4_V2_M1[7]]
        m2 = [N4_V2_M2[0], N4_V1_M2[1], N4_V2_M2[2], N4_V1_M2[3], N4_V2_M2[4], N4_V1_M2[5], N4_V2_M2[6]]
        m3 = [N4_V1_M3[0], N4_V2_M3[1], N4_V1_M3[2], N4_V2_M3[3], N4_V1_M3[4]]
        m4 = [N4_V2_M4[0], N4_V1_M4[1], N4_V2_M4[2], N4_V1_M4[3], N4_V2_M4[4], N4_V1_M4[5], N4_V2_M4[6], N4_V1_M4[7]]
    elif exam_idx == 4:
        m1 = [N4_V2_M1[0], N4_V1_M1[1], N4_V2_M1[2], N4_V1_M1[3], N4_V2_M1[4], N4_V1_M1[5], N4_V2_M1[6], N4_V1_M1[7]]
        m2 = [N4_V1_M2[0], N4_V2_M2[1], N4_V1_M2[2], N4_V2_M2[3], N4_V1_M2[4], N4_V2_M2[5], N4_V1_M2[6]]
        m3 = [N4_V2_M3[0], N4_V1_M3[1], N4_V2_M3[2], N4_V1_M3[3], N4_V2_M3[4]]
        m4 = [N4_V1_M4[0], N4_V2_M4[1], N4_V1_M4[2], N4_V2_M4[3], N4_V1_M4[4], N4_V2_M4[5], N4_V1_M4[6], N4_V2_M4[7]]
    elif exam_idx == 5:
        m1 = N4_V1_M1
        m2 = N4_V2_M2
        m3 = [N4_V2_M3[1], N4_V1_M3[2], N4_V2_M3[3], N4_V1_M3[4], N4_V2_M3[0]]
        m4 = [N4_V1_M4[1], N4_V2_M4[2], N4_V1_M4[3], N4_V2_M4[4], N4_V1_M4[5], N4_V2_M4[6], N4_V1_M4[7], N4_V2_M4[0]]
    elif exam_idx == 6:
        m1 = N4_V2_M1
        m2 = N4_V1_M2
        m3 = [N4_V1_M3[1], N4_V2_M3[2], N4_V1_M3[3], N4_V2_M3[4], N4_V1_M3[0]]
        m4 = [N4_V2_M4[1], N4_V1_M4[2], N4_V2_M4[3], N4_V1_M4[4], N4_V2_M4[5], N4_V1_M4[6], N4_V2_M4[7], N4_V1_M4[0]]
    elif exam_idx == 7:
        m1 = [N4_V1_M1[1], N4_V1_M1[3], N4_V1_M1[5], N4_V1_M1[7], N4_V2_M1[0], N4_V2_M1[2], N4_V2_M1[4], N4_V2_M1[6]]
        m2 = [N4_V1_M2[1], N4_V1_M2[3], N4_V1_M2[5], N4_V2_M2[0], N4_V2_M2[2], N4_V2_M2[4], N4_V2_M2[6]]
        m3 = [N4_V1_M3[1], N4_V1_M3[3], N4_V2_M3[0], N4_V2_M3[2], N4_V2_M3[4]]
        m4 = [N4_V1_M4[1], N4_V1_M4[3], N4_V1_M4[5], N4_V1_M4[7], N4_V2_M4[0], N4_V2_M4[2], N4_V2_M4[4], N4_V2_M4[6]]
    elif exam_idx == 8:
        m1 = [N4_V2_M1[1], N4_V2_M1[3], N4_V2_M1[5], N4_V2_M1[7], N4_V1_M1[0], N4_V1_M1[2], N4_V1_M1[4], N4_V1_M1[6]]
        m2 = [N4_V2_M2[1], N4_V2_M2[3], N4_V2_M2[5], N4_V1_M2[0], N4_V1_M2[2], N4_V1_M2[4], N4_V1_M2[6]]
        m3 = [N4_V2_M3[1], N4_V2_M3[3], N4_V1_M3[0], N4_V1_M3[2], N4_V1_M3[4]]
        m4 = [N4_V2_M4[1], N4_V2_M4[3], N4_V2_M4[5], N4_V2_M4[7], N4_V1_M4[0], N4_V1_M4[2], N4_V1_M4[4], N4_V1_M4[6]]
    elif exam_idx == 9:
        m1 = [N4_V1_M1[7], N4_V1_M1[6], N4_V1_M1[5], N4_V1_M1[4], N4_V2_M1[3], N4_V2_M1[2], N4_V2_M1[1], N4_V2_M1[0]]
        m2 = [N4_V1_M2[6], N4_V1_M2[5], N4_V1_M2[4], N4_V2_M2[3], N4_V2_M2[2], N4_V2_M2[1], N4_V2_M2[0]]
        m3 = [N4_V1_M3[4], N4_V1_M3[3], N4_V1_M3[2], N4_V2_M3[1], N4_V2_M3[0]]
        m4 = [N4_V1_M4[7], N4_V1_M4[6], N4_V1_M4[5], N4_V1_M4[4], N4_V2_M4[3], N4_V2_M4[2], N4_V2_M4[1], N4_V2_M4[0]]
    else: # 10
        m1 = [N4_V2_M1[7], N4_V2_M1[6], N4_V2_M1[5], N4_V2_M1[4], N4_V1_M1[3], N4_V1_M1[2], N4_V1_M1[1], N4_V1_M1[0]]
        m2 = [N4_V2_M2[6], N4_V2_M2[5], N4_V2_M2[4], N4_V1_M2[3], N4_V1_M2[2], N4_V1_M2[1], N4_V1_M2[0]]
        m3 = [N4_V2_M3[4], N4_V2_M3[3], N4_V2_M3[2], N4_V1_M3[1], N4_V1_M3[0]]
        m4 = [N4_V2_M4[7], N4_V2_M4[6], N4_V2_M4[5], N4_V2_M4[4], N4_V1_M4[3], N4_V1_M4[2], N4_V1_M4[1], N4_V1_M4[0]]
...
js_content = f'''// Multi-Exam Paper Catalog with 10 Full Complete Mock Exams each for JLPT N5 and N4 with 100% Real Broadcast Audio in ALL Listening Sections
...
print(f"Successfully assembled 10 N5 Exams (892 Qs) and 10 N4 Exams (971 Qs) with 100% REAL AUDIO in {target_path}!")
